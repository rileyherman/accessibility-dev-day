...
@Component({
  ...
  template: `
    ...
    <!-- 
      ...
      and it's good for SEO. Further, it doesn't take any longer to type <a> than it does <div>. 
      ...
      - Use <h_> for your headers: a screen reader can allow a user to quickly jump between headings, which
        only works when there are headings to jump to. 
      - I know it's not 1998 but for the love of God do NOT use a <table> for layouts. A screen reader would 
      ...
      - If you really need to use a <div> in place of a more semantic tag (for example, some implementations 
        ...
        event listener to call the onClick() when the Enter key is pressed)
      ...
      Providing adequate context is very important for link text. Screen readers usually have a feature where
      they bring up a list of every link on the page - thus removing the context. Text like "click me" can be
      very frustrating in this scenario. However, this isn't event a problem for this piece of code yet - it's
